...
public class GamePlayerAway extends DataBaseObject implements Serializable {

	public GamePlayerAway() {
	}
	
	private GamePlayerIdAway pk = new GamePlayerIdAway();
	private int goals;

	@EmbeddedId
	public GamePlayerIdAway getPk() {
		return pk;
	}

	public void setPk(GamePlayerIdAway pk) {
		this.pk = pk;
	}
	...
	public boolean equals(Object o) {
		...
		GamePlayerAway that = (GamePlayerAway) o;
